...
<body onload="odliczanie(), podaj_date(); ">
	...
	<header class="sticky">
		...
		<nav class="navbar navbar-dark bg-tlonavbar navbar-expand-lg">
			...
			<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#mainmenu" aria-controls="mainmenu" aria-expanded="false" aria-label="Przełącznik nawigacji" id="przelacznik">
